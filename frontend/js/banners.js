  ...
  banners.forEach((banner, idx) => {
    ...
    html += `
      <div class="banner-item-carousel ${idx === 0 ? 'active' : ''}" data-index="${idx}">
        <img src="${desktopImg}" class="banner-img-desktop" alt="${banner.title || ''}" onerror="this.style.display='none'">
        <img src="${mobileImg}" class="banner-img-mobile" alt="${banner.title || ''}" onerror="this.style.display='none'">
      </div>
    `;
  });
